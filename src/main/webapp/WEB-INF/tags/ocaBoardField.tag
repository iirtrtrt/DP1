...
if (${field.getNumber()} == 0) {
    ...
    ctx.stroke();
} else if (${field.getNumber()} == 5 || ${field.getNumber()} == 9 || ${field.getNumber()} == 14 || ${field.getNumber()} == 18 || ${field.getNumber()} == 23 || ${field.getNumber()} == 27 || ${field.getNumber()} == 32 || ${field.getNumber()} == 36 || ${field.getNumber()} == 41 || ${field.getNumber()} == 45 || ${field.getNumber()} == 50 || ${field.getNumber()} == 54 || ${field.getNumber()} == 59) {
    ctx.textAlign="left"; 
